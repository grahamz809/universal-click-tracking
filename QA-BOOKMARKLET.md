...
```
javascript:(function(){var s=document.createElement('script');s.src='https://cdn.jsdelivr.net/gh/grahamz809/universal-click-tracking@d7cdfca/qa-inspector.min.js';document.body.appendChild(s);})();
```
